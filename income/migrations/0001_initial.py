# Generated by Django 3.1.7 on 2021-03-29 13:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='incomes', to='income.source')),
            ],
            options={
                'ordering': ['-date', '-id'],
            },
